...
and the other includes cancerous tissue data from the Cell Model Passport (CMP) project. %TODO Quelle
...
% limitations by the dataset
% TODO - Comes from Limitation in 01
...
%TODO Bezug zur Tabelle mit aufnehmen zB Verlinkung oder nummerierung, variablen nutzen, auf Formeln beziehen
\begin{enumerate}
...
% TODO J - Longer more detailed Caption
\begin{table}[h]
    \centering
