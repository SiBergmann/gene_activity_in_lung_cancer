...
% While our analysis identified these top-scoring genes as having high connectivity within the network, this result relies on an assumption that may not hold in all cases.
% TODO Meaning?!
...
% TODO plot the distribution of interactions by protein - plot is quite left skewed
