...
%general Notes
As the final milestone of our study goal we need to fulfill the last objective\ref{obj:validation} by analyzing and
...
The data ranges from approximately -0.709 to 0.423, suggesting moderate variability, and a normal-like distribution~\ref{fig:03_02_delta_tpm}.
\newline
